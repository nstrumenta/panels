...
import { SavedProps, PlaybackConfig, MosaicDropTargetPosition } from '@base/types/panels';
...
function changePanelLayout(
  ...
  const panelIds: string[] = getLeaves(layout ?? null).filter((panelId) => !isEmpty(panelId));
