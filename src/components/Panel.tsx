...
import KeyListener from '@base/components/KeyListener';
import { MosaicPathContext } from '@base/components/MosaicPathContext';
import PanelContext from '@base/components/PanelContext';
import PanelErrorBoundary from '@base/components/PanelErrorBoundary';
import { PanelRoot, PANEL_ROOT_CLASS_NAME } from '@base/components/PanelRoot';
import { useCurrentLayoutActions, useSelectedPanels } from '@base/context/CurrentLayoutContext';
import { usePanelCatalog } from '@base/context/PanelCatalogContext';
import { useWorkspaceStore, WorkspaceStoreSelectors } from '@base/context/WorkspaceContext';
import usePanelDrag from '@base/hooks/usePanelDrag';
import { TabPanelConfig } from '@base/types/layouts';
import { OpenSiblingPanel, PanelConfig, SaveConfig } from '@base/types/panels';
...
>(
  ...
  function ConnectedPanel(props: Props<Config>) {
    ...
    const panelRootRef: React.MutableRefObject<HTMLDivElement | null> =
    ...
    const quickActionsOverlayRef: React.MutableRefObject<HTMLDivElement | null> =
      useRef<HTMLDivElement>(null);
