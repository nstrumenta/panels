...
import LinkHandlerContext from '@base/context/LinkHandlerContext';
...
export default function TextContent(props: PropsWithChildren<Props>): React.ReactElement | null {
