...
import PanelList, { PanelSelection } from '@base/components/PanelList';
import Stack from '@base/components/Stack';
import { useCurrentLayoutActions } from '@base/context/CurrentLayoutContext';
import { MosaicDropResult } from '@base/types/panels';
import { getPanelIdForType } from '@base/util/layout';
