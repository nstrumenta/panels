...
import { Player, PlayerCapabilities, PlayerPresence, TopicStats } from '@base/players/types';
...
function makeTestHook({ player }: { player?: Player; globalVariables?: GlobalVariables }) {
