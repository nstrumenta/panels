...
import {
  ...
  StartDragPayload,
  SwapPanelPayload,
} from '@base/context/CurrentLayoutContext/actions';
import { useLayoutManager } from '@base/context/LayoutManagerContext';
import { useUserProfileStorage } from '@base/context/UserProfileStorageContext';
import { defaultLayout } from '@base/providers/CurrentLayoutProvider/defaultLayout';
import panelsReducer from '@base/providers/CurrentLayoutProvider/reducers';
import { AppEvent } from '@base/services/IAnalytics';
import { LayoutManagerEventTypes } from '@base/services/ILayoutManager';
import { LayoutID } from '@base/services/ILayoutStorage';
import { PanelConfig, UserNodes, PlaybackConfig } from '@base/types/panels';
