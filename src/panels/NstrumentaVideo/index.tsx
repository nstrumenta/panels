...
import { NumberInput } from '@base/components/SettingsTreeEditor/inputs/NumberInput';
...
import { fromMillis, subtract as subtractTimes, toSec } from '@foxglove/rostime';
    ...
    <Stack fullHeight>
            ...
            <Button
              ...
              onClick={() => {
                if (
                  ...
                  experiment.videos[nstrumentaVideoIndex!] = {
                    ...nstrumentaVideo,
                    ...{ offset: Math.round(offsetInput) },
                  };
      ...
      <video
        style={{
          ...
          transform: nstrumentaVideo?.rotate
            ? `rotate(${nstrumentaVideo.rotate}deg) scale(1.77)`
            : undefined,
        }}
        src={videoUrl}
