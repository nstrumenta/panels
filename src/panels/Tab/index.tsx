...
import { EmptyPanelLayout } from '@base/components/EmptyPanelLayout';
import Panel from '@base/components/Panel';
import { usePanelContext } from '@base/components/PanelContext';
import { UnconnectedPanelLayout } from '@base/components/PanelLayout';
import Stack from '@base/components/Stack';
import { DraggingTabPanelState, TabDndContext } from '@base/panels/Tab/TabDndContext';
import { TabbedToolbar } from '@base/panels/Tab/TabbedToolbar';
import { TabPanelConfig as Config } from '@base/types/layouts';
import { SaveConfig } from '@base/types/panels';
import { TAB_PANEL_TYPE } from '@base/util/globalConstants';
import { DEFAULT_TAB_PANEL_CONFIG, updateTabPanelLayout } from '@base/util/layout';
