...
import { useCurrentLayoutSelector } from '@base/context/CurrentLayoutContext';
import { useStateToURLSynchronization } from '@base/hooks/useStateToURLSynchronization';
import EventsProvider from '@base/providers/EventsProvider';

jest.mock('@base/context/CurrentLayoutContext');
jest.mock('@base/components/MessagePipeline');
