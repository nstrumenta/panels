...
} from '@base/components/MessagePipeline';
import { usePanelContext } from '@base/components/PanelContext';
import PanelToolbar from '@base/components/PanelToolbar';
import { useAppConfiguration } from '@base/context/AppConfigurationContext';
import { ExtensionCatalog, useExtensionCatalog } from '@base/context/ExtensionCatalogContext';
import {
  useClearHoverValue,
  useHoverValue,
  useSetHoverValue,
} from '@base/context/TimelineInteractionStateContext';
import useGlobalVariables from '@base/hooks/useGlobalVariables';
import { useSynchronousMountedState } from '@base/hooks/useSynchronousMountedState';
import { AdvertiseOptions, PlayerCapabilities, SubscribePayload } from '@base/players/types';
import {
  usePanelSettingsTreeUpdate,
  useSharedPanelState,
  useDefaultPanelTitle,
} from '@base/providers/PanelStateContextProvider';
import { PanelConfig, SaveConfig } from '@base/types/panels';
import { assertNever } from '@base/util/assertNever';
