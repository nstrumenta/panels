...
import { openSiblingPlotPanel, plotableRosTypes } from '@base/panels/Plot';
import {
  openSiblingStateTransitionsPanel,
  transitionableRosTypes,
} from '@base/panels/StateTransitions';
import { OpenSiblingPanel } from '@base/types/panels';
import clipboard from '@base/util/clipboard';
