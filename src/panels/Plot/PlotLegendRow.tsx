...
import TimeBasedChart from '@base/components/TimeBasedChart';
import { useSelectedPanels } from '@base/context/CurrentLayoutContext';
import { useHoverValue } from '@base/context/TimelineInteractionStateContext';
import { useWorkspaceActions } from '@base/context/WorkspaceContext';
import { plotPathDisplayName } from '@base/panels/Plot/types';
import { getLineColor } from '@base/util/plotColors';
