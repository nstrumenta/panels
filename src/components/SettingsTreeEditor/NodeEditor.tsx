...
import { HighlightedText } from '@base/components/HighlightedText';
...
const SelectVisibilityFilterOptions: () => {
  label: string;
...
const getSelectVisibilityFilterField = () =>
  ({
    input: 'select',
    label: 'filterList',
    help: 'filterListHelp',
    ...
    <>
      ...
      {state.open && selectVisibilityFilterEnabled && hasChildren && (
        <FieldEditor
          ...
          field={{ ...getSelectVisibilityFilterField(), value: state.visibilityFilter }}
