...
import { DraggableToolbarTab } from '@base/panels/Tab/DraggableToolbarTab';
import { DraggingTabItem, TAB_DRAG_TYPE, TabActions } from '@base/panels/Tab/TabDndContext';
import { TabConfig } from '@base/types/layouts';
...
export function TabbedToolbar(props: Props): JSX.Element {
  ...
  useEffect(() => {
    setDraggingTabState({ item: item as DraggingTabItem | undefined, isOver });
