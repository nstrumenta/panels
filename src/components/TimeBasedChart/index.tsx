...
import ChartComponent from '@base/components/Chart/index';
import { RpcElement, RpcScales } from '@base/components/Chart/types';
import KeyListener from '@base/components/KeyListener';
import { useMessagePipeline } from '@base/components/MessagePipeline';
...
import type { ZoomOptions } from '@base/chartjs-plugin-zoom/types/options';
