...
import { DataSourceEvent, EventsStore, useEvents } from '@base/context/EventsContext';
import { NstrumentaLabels, useNstrumentaContext } from '@base/context/NstrumentaContext';
import {
  ...
  const saveLabels = async () => {
    ...
    for (const labelFile of experiment.labelFiles) {
      ...
      if (serializedEvents) {
        ...
        await uploadBytes(ref(firebaseInstance.storage, labelFile.filePath), data);
      }
    }
  };
