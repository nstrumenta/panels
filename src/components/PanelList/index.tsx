...
import TextHighlight from '@base/components/TextHighlight';
import { useCurrentLayoutActions, usePanelMosaicId } from '@base/context/CurrentLayoutContext';
import { PanelInfo, usePanelCatalog } from '@base/context/PanelCatalogContext';
import { ExtensionNamespace } from '@base/types/Extensions';
import {
  PanelConfig,
  MosaicDropTargetPosition,
  SavedProps,
  MosaicDropResult,
} from '@base/types/panels';
...
function DraggablePanelItem({
  ...
  const scrollRef: React.MutableRefObject<HTMLElement | null> = useRef<HTMLElement>(null);
