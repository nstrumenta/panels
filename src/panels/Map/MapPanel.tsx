...
import FilteredPointLayer, { POINT_MARKER_RADIUS } from '@base/panels/Map/FilteredPointLayer';
import { FoxgloveMessages } from '@base/types/FoxgloveMessages';
import { darkColor, lightColor, lineColors } from '@base/util/plotColors';
