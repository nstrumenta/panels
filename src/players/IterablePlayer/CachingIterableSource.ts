...
class CachingIterableSource implements IIterableSource {
  ...
  public async *messageIterator(
    ...
    for (;;) {
      ...
      let block: CacheBlock | undefined = this.cache[cacheBlockIndex];
