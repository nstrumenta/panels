...
import { FieldEditor } from '@base/components/SettingsTreeEditor/FieldEditor';
...
import { getPanelTypeFromId, PANEL_TITLE_CONFIG_KEY } from '@base/util/layout';
      ...
      {settings.enableFilter === true && (
        <header className={classes.appBar}>
          <TextField
            ...
            fullWidth
            placeholder={'searchPanelSettings'}
            InputProps={{
              size: 'small',
              startAdornment: (
